    ...
    if (!task) {
        return (
            <div className="container mx-auto p-6 text-center">
                ...
                <Link href="/task/list">
                    <a className="inline-block px-6 py-3 text-lg font-semibold text-white bg-blue-600 rounded-md shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400">
                        Back to Task List
                    </a>
                </Link>
            </div>
