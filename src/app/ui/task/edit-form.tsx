...
import { TaskForm, TaskField } from '@/app/lib/definitions';
...
export default function EditTask({
    ...
    const initialState: State = { message: null, errors: { id: [], title: [], description: [], priority: [], date: [], status: [] } };
                ...
                <div className="mb-4">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            {/* create a option task list loop using map */}
                            {tasks.map((task) => (
                        ...
                        <div className="flex gap-4">
                            ...
                            <div className="flex items-center">
                                <input
                                    ...
                                    type="radio"
                                    value="true"
                                    defaultChecked={task.status === true}
                                    className="h-4 w-4 border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                                />
                                <label
                                    htmlFor="status"
                                ...
                                >
                                    status <CheckIcon className="h-4 w-4" />
                                </label>
                            </div>
                        </div>
                    </div>
